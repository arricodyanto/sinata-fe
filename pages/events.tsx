    ...
    <Box className='bg-white'>
        ...
        <Container sx={{width: {xs: 380, sm: 760, lg: 1280}}}>
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} md={4}>
                <Typography variant='h5' className='font-bold mb-2' color='primary'>Agenda Hari Ini</Typography>
                <TodaysEvent />
              </Grid>
              <Grid item xs={12} md={4}>
                <Typography variant='h5' className='font-bold mb-2' color='primary'>Agenda Selanjutnya</Typography>
                <TomorrowsEvent />
              </Grid>
            </Grid>
            <Box className='mt-10'>
              <Typography variant='h5' className='font-bold mb-2' color='primary'>Semua Agenda</Typography>
              <AllEvents />
            </Box>
        </Container>
        <Footer />
