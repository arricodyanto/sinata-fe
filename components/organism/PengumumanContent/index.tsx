    ...
    <>
        {
            pengumuman.map((item) => {
                ...
                return (
                    <Grid item container xs={12} sm={6} key={item.id} className='border border-gray-100 mb-10 p-0'>
                        <Grid item xs={2} className='px-4'>
                            <Paper component={Stack} direction="column" justifyContent="center" className='bg-primary text-center h-16 rounded-none'>
                                <Typography variant='body2' className='font-bold text-light uppercase' sx={{fontSize: {xs: 6, sm: 8, lg: 13}}}>
                                    {monthString}
                                </Typography>
                            </Paper>
                            <Paper component={Stack} sx={{display: {xs: 'none', sm: 'none', md: 'flex'}}} direction="column" justifyContent="center" elevation={0} className='bg-light text-center h-16 rounded-none'>
                                <Typography variant='caption' className='text-gray-600' sx={{fontSize: 8}}>
                                    {item.date}
                                </Typography>
                            </Paper>
                        </Grid>
