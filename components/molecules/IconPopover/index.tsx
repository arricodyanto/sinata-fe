...
export default function IconPopover(props: TIconPopoverProps) {
  ...
  return (
    <>
        ...
        <Popover id={id} open={open} anchorEl={anchorEl} onClose={handleClose} className='translate-y-5' anchorOrigin={{ vertical: 'bottom', horizontal: 'center' }} transformOrigin={{ vertical: 'top', horizontal: 'center' }} PaperProps={{sx: {boxShadow: '0 4px 6px -1px rgb(0 0 0 / 0.1), 0 2px 4px -2px rgb(0 0 0 / 0.1)'}}} TransitionComponent={Zoom}>
            {content()}
        </Popover>
    </>
  )
